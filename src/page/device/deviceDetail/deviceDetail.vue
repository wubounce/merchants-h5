  ...
  <section>
    ...
    <div v-else>
      ...
      <div class="about-button">
        ...
        <Button btn-type="small" btn-color="spe" class="ft-btn active" @click.native="deviceRest" v-show="machineState==='运行' || machineState==='空闲' || deviceDetail.subTypeName === '通用脉冲充电桩'" v-has="'mer:machine:reset'">复位</Button>
