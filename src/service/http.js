...
// const baseUrl = process.env.NODE_ENV === 'production' ? 'http://192.168.5.10:/merchant/' : 'http://192.168.5.10:8089/merchant/'; 
const baseUrl = process.env.NODE_ENV === 'production' ? 'https://pre.api.qiekj.com/merchant/' : 'http://192.168.5.10:8089/merchant/'; 
// 创建axios实例
